...
ArcFurnace.removeRecipe(<rockhounding_chemistry:metal_items:3>);
...
ArcFurnace.removeRecipe(<rockhounding_chemistry:metal_items:11>);
ArcFurnace.removeRecipe(<thermalfoundation:material:129>);
ArcFurnace.removeRecipe(<rockhounding_chemistry:metal_items:5>);
ArcFurnace.removeRecipe(<rockhounding_chemistry:metal_items:13>);
ArcFurnace.removeRecipe(<thermalfoundation:material:135>);
ArcFurnace.removeRecipe(<rockhounding_chemistry:metal_items:9>);
...
ArcFurnace.removeRecipe(<qmd:ingot_alloy:5>);

var dustMelt = {
    <ore:dustNickel> : <rockhounding_chemistry:metal_items:13>,
    <ore:dustAluminium> : <rockhounding_chemistry:metal_items:3>,
    ...
    <ore:dustNichrome> : <rockhounding_chemistry:alloy_items_tech:22>
...
BlastFurnace.addRecipe(<thermalfoundation:material:224>*6, <primal:ore_cluster_bog_iron>, 1000, <immersiveengineering:material:7>*2);
...
Blueprint.addRecipe("pipes", <thermaldynamics:duct_32>*2 , 
[<logisticspipes:pipe_transport_basic>,<thaumcraft:nugget:5>]);

Blueprint.addRecipe("components", <tetra:vent_plate>*3 , 
[<minecraft:iron_bars>,<primal:iron_mesh>]);

Blueprint.addRecipe("components", <nuclearcraft:part:6>*2, 
[<minecraft:potato>]);

Blueprint.addRecipe("components", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:blood_generator_2"}), 
[<contenttweaker:vivid_crystal>,<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:blood_generator_1"})]);

Blueprint.addRecipe("components", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:bot_generator_2"}), 
[<contenttweaker:mana_crystal>,<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:bot_generator_1"})]);

Blueprint.addRecipe("components", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:astral_generator_2"}), 
[<contenttweaker:effulgent_crystal>,<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:astral_generator_1"})]);

Blueprint.addRecipe("components", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:thaum_generator_2"}), 
[<contenttweaker:infused_crystal>,<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:thaum_generator_1"})]);

Blueprint.addRecipe("components", <contenttweaker:levitate_device>, 
[<darkutils:shulker_pearl>,<immersiveengineering:wirecoil:2>,<rockhounding_chemistry:alloy_parts:85>,<appliedenergistics2:material:24>]);

Blueprint.addRecipe("components", <enderio:item_material:65>*4, 
[<extrautils2:powertransmitter>, <thermalfoundation:material:32>]);

Blueprint.addRecipe("components", <nuclearcraft:part:9>*2, 
[<ore:plateSteel>, <immersiveengineering:material:8>, <ore:stickSteel>, <immersiveengineering:material:20>, <logisticspipes:chip_basic>]);

Blueprint.addRecipe("components", <nuclearcraft:part:7>*2, 
[<logisticspipes:chip_basic>, <ore:plateInvar>, <ic2:crafting:6>, <immersiveengineering:material:20>, <ore:gearSteel>]);

Blueprint.addRecipe("components", <contenttweaker:igniter>, 
[<rockhounding_chemistry:misc_items:1>, <ore:plateSteel>, <ore:stickSteel>, <rockhounding_chemistry:alloy_items_deco:2>, <minecraft:iron_nugget>, <ic2:crafting:6>]);

Blueprint.addRecipe("components", <extrautils2:passivegenerator>*2, 
[<ore:plateInvar>, <logisticspipes:chip_basic>, <extrautils2:ingredients>, <thaumcraft:mirrored_glass>]);

Blueprint.addRecipe("electronics", <logisticspipes:chip_basic>, 
[<ic2:cable>.withTag({type: 0 as byte, insulation: 0 as byte})*2, <nuclearcraft:part:6>]);

Blueprint.addRecipe("electronics", <logisticspipes:chip_basic>, 
[<immersiveengineering:material:20>*2, <nuclearcraft:part:6>]);

Blueprint.addRecipe("electronics", <contenttweaker:igniter>, 
[<rockhounding_chemistry:misc_items:1>, <ore:plateSteel>, <ore:stickSteel>, <minecraft:quartz>, <immersiveengineering:wirecoil>, <nuclearcraft:part:7>]);

Blueprint.addRecipe("electronics", <logisticspipes:chip_advanced>, 
[<ore:dustSmallDiamond>, <ic2:cable>.withTag({type: 0 as byte, insulation: 0 as byte})*2, <appliedenergistics2:material:20>, <nuclearcraft:part:6>]);

Blueprint.addRecipe("electronics", <rockhounding_chemistry:misc_items:1>*2, 
[<logisticspipes:chip_basic>, <appliedenergistics2:material:18>,<rockhounding_chemistry:misc_items:3>*2,<ic2:cable:2>.withTag({type: 2 as byte, insulation: 0 as byte})*2]);

Blueprint.addRecipe("electronics", <rockhounding_chemistry:misc_items:10>*2, 
[<logisticspipes:chip_advanced>, <appliedenergistics2:material:16>,<rockhounding_chemistry:misc_items:3>*2,<minecraft:redstone>*2]);

Blueprint.addRecipe("electronics", <logisticspipes:chip_fpga>, 
[<ore:dustSmallDiamond>, <ic2:cable>.withTag({type: 0 as byte, insulation: 0 as byte}), <ic2:cable:2>.withTag({type: 2 as byte, insulation: 0 as byte}), <ore:dustSmallLapis>, <appliedenergistics2:material:20>, <nuclearcraft:part:6>]);

Blueprint.addRecipe("channels", <appliedenergistics2:controller>, 
[<qmd:discharge_lamp:5>,<qmd:semiconductor:6>*2,<appliedenergistics2:material:44>,<appliedenergistics2:material:43>,<nuclearcraft:part:12>,<qmd:ingot_alloy:6>]);
...
for i in 0 to 13
{
    Crusher.removeRecipesForInput(<geolosys:cluster>.definition.makeStack(i));
}
for i in 0 to 8
{
    Crusher.removeRecipesForInput(<nuclearcraft:ore>.definition.makeStack(i));
    Crusher.removeRecipesForInput(<biomesoplenty:gem_ore>.definition.makeStack(i));
}
for i in 0 to 5
{
    Crusher.removeRecipesForInput(<immersiveengineering:ore>.definition.makeStack(i));
}
for i in 0 to 9
{
    Crusher.removeRecipesForInput(<thermalfoundation:ore>.definition.makeStack(i));
}
val geoCrRemove = [1,3,4,5,6] as int[];
for i in geoCrRemove
{
    Crusher.removeRecipesForInput(<geolosys:ore_vanilla>.definition.makeStack(i));
}